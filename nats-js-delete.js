...
async function deleteStream({ server, name, subjects, retention, storage }) {
    try {
...
if (require.main === module) {
    program
        ...
        .addHelpText('after', `
Examples:
  $ nats-js-delete                                   # Delete all streams
  $ nats-js-delete -n stream1                        # Delete specific stream
  $ nats-js-delete -r workqueue                      # Filter by workqueue retention
  $ nats-js-delete -g file                           # Filter by file storage`)
        .parse();
